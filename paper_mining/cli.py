...
def build_parser() -> argparse.ArgumentParser:
    ...
    # Security-only change: the historical experiment had an embedded key. This does not alter model/prompt/parameters.
    parser.add_argument("--api-key", default=None, help="API key. Prefer env DASHSCOPE_API_KEY or QWEN_API_KEY.")
